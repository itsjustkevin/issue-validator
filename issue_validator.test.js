...
describe('Parse github issue markdown', () => {
...
describe('validateGithubIssue', () => {
  ...
  test('should return an array of error messages for an invalid GitHub issue', () => {
    const issue = {
      issue_link: '',
      'Commit Hash': '',
      Target: 'stable',
    ...
    expect(errors).toEqual([
      'Missing or empty value for "issue_link".',
      'Missing or empty value for "Commit Hash".',
      'Missing or empty value for "pr_link".',
      'Missing or empty value for "Impacted Users".'
    ]);
  });
});
